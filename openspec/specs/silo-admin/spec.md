...
one of four classes — bootstrap, unseen, seen with access, seen without — deciding access by
...
anything. A passkey is never logged, never written to a file by the app, and never rendered in
full again.
